...
Bootstrap and secure server in 5 minutes.
Based on [phred/5minbootstrap](https://github.com/phred/5minbootstrap) by [Fred Alger](https://github.com/phred)
...
[https://github.com/amatashkin/5minbootstrap/](https://github.com/amatashkin/5minbootstrap/)

    yourmachine ~$ git clone https://github.com/amatashkin/5minbootstrap.git
...
## Step 4: Update the SSH public key.
    ...
    yourmachine ~/5minbootstrap$ cp ~/.ssh/id_dsa.pub ./authorized_keys
